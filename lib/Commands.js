...
class SnowmixCommands {
    ...
    populateFromShowCommand() {
        ...
        .then(arrayOfLines => {
            ...
            showingItems['text'].forEach(id => { this.snowmix.texts.byId(id).showing = true })
            showingItems['vfeed'].forEach(id => { this.snowmix.vfeeds.byId(id).showing = true })
            showingItems['image'].forEach(id => { this.snowmix.imagePlaces.byId(id).showing = true })
        })
    }
