 ...
 *
 * @extends VisibleItem
 * Create with snowmix.texts.create(...)
 ...
 * @property {float} red - between 0 and 1
 * @property {float} green - between 0 and 1
 * @property {float} blue - between 0 and 1
 * @property {float} alpha - between 0 and 1
 * @property {float} backgroundRed - between 0 and 1
 * @property {float} backgroundGreen - between 0 and 1
 * @property {float} backgroundBlue - between 0 and 1
 * @property {float} backgroundAlpha - between 0 and 1
 * @property {integer} backgroundLeftPad - pixels padding of the background
 * @property {integer} backgroundRightPad - pixels padding of the background
 * @property {integer} backgroundTopPad - pixels padding of the background
 * @property {integer} backgroundBottomPad - pixels padding of the background
 * @property anchor
 * @property offset
 */
